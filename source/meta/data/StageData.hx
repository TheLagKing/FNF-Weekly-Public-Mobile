...
typedef StageFile = {
    ...
    // Prefix and Suffix shit
	var introPrefix:String; // Only for graphics atm
	var introSuffix:String; // Only for sounds atm
	var comboPrefix:String; // Mainly meant to specifiy a folder
